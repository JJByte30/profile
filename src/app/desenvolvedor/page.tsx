                ...
                <article>
                    <ul className="flex flex-col tracking-wider marker:text-white gap-y-4 mx-6 mb-4">
                        <li>
                            ...
                            <p className="text-white whitespace-pre-line">Meu primeiro contato com programação aconteceu em 2018/2019, durante um curso na Bit+ Uberaba, onde comecei a entender lógica de programação e dar os primeiros passos no mundo da tecnologia. Alguns anos depois, iniciei a graduação em Análise e Desenvolvimento de Sistemas, que consolidou minha base de conhecimento em desenvolvimento web, banco de dados e programação orientada a objetos. Desde então, venho aprimorando minhas habilidades e direcionando minha carreira para o desenvolvimento de sistemas modernos e eficientes.</p>
                        </li>
                        <li>
                            <h2 className="font-semibold text-white">- Experiencias:</h2>
                            <p className="text-white whitespace-pre-line">Entre setembro de 2024 e setembro de 2025, atuei na Codiub (Companhia de Desenvolvimento de Informática de Uberaba), onde tive a oportunidade de trabalhar em diferentes frentes do desenvolvimento de software.</p>
                            ...
                            <p className="text-white whitespace-pre-line">Passei por Angular no frontend e Java (Spring Boot) no backend, mas meu principal foco foi o desenvolvimento com React e Next.js, criando interfaces modernas, performáticas e alinhadas às boas práticas do mercado.</p>
                        </li>
